/******************************************************************************
* An implementaation of Andrew Gilpin's gdb debugging tutorial "main.cpp"
* For the actual tutorial: http://students.cec.wustl.edu/~agg1/tutorial/
* Compile with: g++ gdbTutor.cpp -o main -ggdb -Wall -c++std=0x
******************************************************************************/
#include <iostream>
using std::cout;
...
//			marker = 0;  // reset the marker (This causes the segfault, comment it out).
			temp = marker;
			marker = marker->next();
			delete temp;	// Added this line.
			temp = 0;		// Added this line.
		}
...
int main(int argc, char **argv) {
	...
	cout << "The fully created list is:" << '\n';
	list->print();
